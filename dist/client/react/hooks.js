...
function _usePasswordless() {
    ...
    return {
        ...
        authenticateWithSRP: ({ username, password, smsMfaCode, otpMfaCode, clientMetadata, }) => {
            setLastError(undefined);
        ...
        authenticateWithPlaintextPassword: ({ username, password, smsMfaCode, otpMfaCode, clientMetadata, }) => {
            setLastError(undefined);
        ...
        completeSignUpFlow: async ({ username, email, password, userAttributes, clientMetadata, }) => {
            setLastError(undefined);
            try {
