...
export function authenticateWithSRP({ username, password, smsMfaCode, otpMfaCode, newPassword, customChallengeAnswer, authflow = "USER_SRP_AUTH", tokensCb, statusCb, clientMetadata, }) {
