...
type ConfigInput = Omit<Config, "cognitoIdpEndpoint"> & Partial<Pick<Config, "cognitoIdpEndpoint">>;
export declare function configure(config?: ConfigInput): ConfigWithDefaults;
