...
export declare function authenticateWithSRP({ username, password, smsMfaCode, otpMfaCode, newPassword, customChallengeAnswer, authflow, tokensCb, statusCb, clientMetadata, }: {
    /**
