...
export declare const bufferFromBase64: (base64: string) => Uint8Array<ArrayBuffer>;
export declare const bufferFromBase64Url: (base64: string) => Uint8Array<ArrayBuffer>;
